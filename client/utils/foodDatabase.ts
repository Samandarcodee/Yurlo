...
export const UZBEK_FOODS: FoodItem[] = [
  // Traditional Uzbek dishes
  {
    ...
    nutrition: { calories: 420, protein: 18, carbs: 65, fat: 12, fiber: 3, sugar: 2, sodium: 850 },
  ...
  },
  {
    ...
    nutrition: { calories: 380, protein: 22, carbs: 45, fat: 14, fiber: 4, sugar: 6, sodium: 920 },
  ...
  },
  {
    ...
    nutrition: { calories: 320, protein: 16, carbs: 35, fat: 15, fiber: 2, sugar: 3, sodium: 650 },
  ...
  },
  {
    ...
    nutrition: { calories: 280, protein: 12, carbs: 25, fat: 16, fiber: 2, sugar: 2, sodium: 480 },
  ...
  },
  {
    ...
    nutrition: { calories: 220, protein: 18, carbs: 12, fat: 12, fiber: 3, sugar: 4, sodium: 780 },
  ...
  // Bread and grain products
  {
    ...
    nutrition: { calories: 180, protein: 6, carbs: 35, fat: 2, fiber: 3, sugar: 1, sodium: 320 },
  ...
  },
  {
    ...
    nutrition: { calories: 130, protein: 3, carbs: 28, fat: 0.3, fiber: 0.4, sugar: 0.1, sodium: 5 },
  ...
  // Vegetables
  {
    ...
    category: 'vegetables',
    serving: { size: '1 dona', unit: 'dona', grams: 120 },
    nutrition: { calories: 50, protein: 1, carbs: 12, fat: 0.2, fiber: 3.6, sugar: 6, sodium: 69 },
  ...
  },
  {
    ...
    nutrition: { calories: 60, protein: 1.7, carbs: 14, fat: 0.2, fiber: 2.7, sugar: 6.8, sodium: 6 },
  ...
  // Fruits
  {
    ...
    nutrition: { calories: 95, protein: 0.5, carbs: 25, fat: 0.3, fiber: 4.4, sugar: 19, sodium: 2 },
  ...
  },
  {
    ...
    nutrition: { calories: 104, protein: 1.1, carbs: 27, fat: 0.2, fiber: 1.4, sugar: 23, sodium: 3 },
  ...
  // Protein sources
  {
    ...
    nutrition: { calories: 294, protein: 25, carbs: 0, fat: 21, fiber: 0, sugar: 0, sodium: 72 },
  ...
  },
  {
    ...
    category: 'protein',
    serving: { size: '100g', unit: 'gramm', grams: 100 },
    nutrition: { calories: 231, protein: 31, carbs: 0, fat: 10, fiber: 0, sugar: 0, sodium: 104 },
  ...
  // Dairy
  {
    ...
    category: 'dairy',
    serving: { size: '100g', unit: 'gramm', grams: 100 },
    nutrition: { calories: 98, protein: 11, carbs: 3.4, fat: 4.3, fiber: 0, sugar: 2.7, sodium: 364 },
  ...
  },
  {
    ...
    nutrition: { calories: 149, protein: 8, carbs: 12, fat: 8, fiber: 0, sugar: 12, sodium: 105 },
  ...
  // Common snacks
  {
    ...
    nutrition: { calories: 196, protein: 4.6, carbs: 4.1, fat: 19.6, fiber: 2, sugar: 0.8, sodium: 1 },
  ...
  // Beverages
  {
    ...
    category: 'beverages',
    serving: { size: '1 stakan', unit: 'stakan', grams: 240 },
    nutrition: { calories: 2, protein: 0.5, carbs: 0, fat: 0, fiber: 0, sugar: 0, sodium: 2 },
...
export const searchFoods = (query: string, limit: number = 10): FoodItem[] => {
  ...
  return results
    .sort((a, b) => {
      ...
      const aExactMatch = a.nameUz.toLowerCase() === searchTerm || a.name.toLowerCase() === searchTerm;
      const bExactMatch = b.nameUz.toLowerCase() === searchTerm || b.name.toLowerCase() === searchTerm;
...
export const getRecentMeals = (telegramId: string, limit: number = 5): Meal[] => {
  ...
  const uniqueMeals = recentMeals
    ...
    .filter((meal, index, arr) => 
      arr.findIndex(m => m.name.toLowerCase() === meal.name.toLowerCase()) === index
    );
...
export const simulateAIRecognition = (imageName?: string): Promise<{
  food: FoodItem;
  confidence: number;
  portion: number;
}> => {
...
export const getNutritionScore = (nutrition: { calories: number, protein: number, carbs: number, fat: number, fiber: number }): {
  score: number;
  grade: string;
  feedback: string[];
} => {
