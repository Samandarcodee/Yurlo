...
const AI_SUGGESTIONS = [
  {
    type: "warning",
    message:
      "Siz bugun 300 kaloriya kam iste'mol qildingiz. Sog'lom atıştırmalık qo'shing.",
  ...
  },
  {
    type: "info",
    message:
      "Kechki ovqat uchun yengil salat tavsiya etamiz - qolgan kaloriyaga mos keladi.",
...
const getCalorieStatus = (
  ...
  if (percentage < 80) {
    status = "under";
    recommendation =
      "Ko'proq ovqat iste'mol qiling. Sog'lom atıştırmalık qo'shing.";
          ...
          <div className="flex-1 space-y-2">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {adjustedFood.calories} kal • {portion}
                {food.unit}
              </p>
            </div>
  ...
  const addFoodToMeal = useCallback(
    (food: Food, mealType?: string) => {
      ...
      if (existingMealIndex >= 0) {
        ...
        updatedMeals[existingMealIndex].totalCalories = calculateMealCalories(
          updatedMeals[existingMealIndex].foods,
        );
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground">
            AI yordamida aqlli ovqat kuzatuvi
          </p>
        </div>
              ...
              <div className="space-y-4">
                <div className="text-center">
                  <div className="relative w-24 h-24 mx-auto">
                    <svg className="transform -rotate-90 w-24 h-24">
                      ...
                      <circle
                        ...
                        r="40"
                        stroke={
                          calorieAnalysis.status === "optimal"
                            ? "#22C55E"
                            : calorieAnalysis.status === "under"
                              ? "#F59E0B"
                              : "#EF4444"
                        }
                        strokeWidth="8"
                  ...
                  <p className="text-xs text-muted-foreground">
                    {calorieAnalysis.remaining > 0
                      ? `${calorieAnalysis.remaining} qoldi`
                      : "Maqsad bajarildi"}
                  </p>
                </div>
              </div>
            ...
            <Card className="glass-light">
              ...
              <CardContent className="space-y-4">
                ...
                <Tabs
                  ...
                  onValueChange={(value: any) => setSelectedMealType(value)}
                >
