          ...
          <CardContent className="space-y-4 sm:space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 text-center">
              <div className="space-y-1 sm:space-y-2 p-3 sm:p-4 bg-white/40 rounded-xl sm:rounded-2xl">
                <p className="text-xs sm:text-sm text-mint-600 font-semibold">
                  Iste'mol
                </p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-mint-800">
                  {userData.caloriesConsumed.toLocaleString()}
                </p>
              </div>
              <div className="space-y-1 sm:space-y-2 p-3 sm:p-4 bg-white/40 rounded-xl sm:rounded-2xl">
                <p className="text-xs sm:text-sm text-mint-600 font-semibold">
                ...
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-mint-600">
                  {userData.caloriesBurned}
                </p>
              </div>
              <div className="space-y-1 sm:space-y-2 p-3 sm:p-4 bg-white/40 rounded-xl sm:rounded-2xl">
                ...
                <p
                  className={`text-xl sm:text-2xl lg:text-3xl font-bold ${caloriesRemaining > 0 ? "text-mint-500" : "text-red-500"}`}
                >
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <div className="relative">
                ...
                />
                <div
                  className="absolute inset-0 bg-gradient-to-r from-mint-400 to-mint-500 rounded-full"
                  style={{
                    width: `${(userData.caloriesConsumed / userData.caloriesTarget) * 100}%`,
                  }}
                ></div>
              </div>
            </div>
        ...
        <div className="space-y-3 sm:space-y-4 animate-fade-in-up">
          ...
          <div className="grid grid-cols-1 gap-3 sm:gap-4">
              ...
              <Button className="w-full h-14 sm:h-16 lg:h-18 bg-gradient-to-r from-mint-500 to-mint-600 hover:from-mint-600 hover:to-mint-700 text-white shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 justify-start text-left rounded-xl sm:rounded-2xl">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm opacity-90">
                    Rasm yuklang yoki ovqat nomini kiriting
                  </p>
                </div>
              </Button>
            </Link>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <Button
                variant="outline"
                className="h-14 sm:h-16 flex-col gap-1 sm:gap-2 border-water-200 hover:bg-water-50 rounded-xl sm:rounded-2xl card-shadow hover:shadow-lg transition-all duration-200 hover:scale-105"
              >
                <div className="p-1.5 sm:p-2 bg-water-100 rounded-lg sm:rounded-xl">
                  <Droplets className="h-5 w-5 sm:h-6 sm:w-6 text-water-600" />
                </div>
                <span className="text-xs sm:text-sm font-semibold text-water-700">
                  Suv Qo'shish
                </span>
              </Button>
              ...
              <Button
                variant="outline"
                className="h-14 sm:h-16 flex-col gap-1 sm:gap-2 border-mint-200 hover:bg-mint-50 rounded-xl sm:rounded-2xl card-shadow hover:shadow-lg transition-all duration-200 hover:scale-105"
              >
                <div className="p-1.5 sm:p-2 bg-mint-100 rounded-lg sm:rounded-xl">
                  <Activity className="h-5 w-5 sm:h-6 sm:w-6 text-mint-600" />
                </div>
                <span className="text-xs sm:text-sm font-semibold text-mint-700">
                  Faoliyat Qo'shish
                </span>
              </Button>
            </div>
          ...
          <Card className="card-shadow hover-lift rounded-xl sm:rounded-2xl overflow-hidden">
            <CardContent className="pt-4 sm:pt-6">
              ...
              <div className="relative mb-2 sm:mb-3">
                <Progress
                  value={waterProgress}
                  className="h-2 sm:h-3 bg-water-50 rounded-full"
                />
                <div
                  className="absolute inset-0 bg-gradient-to-r from-water-400 to-water-500 rounded-full"
                  style={{ width: `${waterProgress}%` }}
                ></div>
              </div>
              <p className="text-xs sm:text-sm text-muted-foreground font-medium">
                {waterProgress >= 100
                  ? "🎉 Ajoyib! Siz kunlik maqsadingizga erishdingiz!"
            ...
            <CardContent className="pt-4 sm:pt-6">
              <div className="flex items-center justify-between mb-3 sm:mb-4">
                ...
                <Badge className="bg-health-100 text-health-700 px-2 sm:px-3 py-1 rounded-full font-bold text-xs sm:text-sm">
                  {userData.stepsToday.toLocaleString()}/
                  {userData.stepsTarget.toLocaleString()}
                </Badge>
              </div>
              <div className="relative mb-2 sm:mb-3">
                <Progress
                  value={stepsProgress}
                  className="h-2 sm:h-3 bg-health-50 rounded-full"
                />
                <div
                  className="absolute inset-0 bg-gradient-to-r from-health-400 to-health-500 rounded-full"
                  style={{ width: `${stepsProgress}%` }}
                ></div>
              </div>
              <p className="text-xs sm:text-sm text-muted-foreground font-medium">
                {stepsProgress >= 100
                  ? "🚀 Zo'r! Siz kunlik qadamlar maqsadini oshib ketdingiz!"
            ...
            <CardContent className="pt-4 sm:pt-6">
              ...
              <div className="flex justify-between text-xs sm:text-sm text-muted-foreground mb-2 sm:mb-3">
                <span className="font-semibold">
                  Hozirgi: {userData.currentWeight} kg
                </span>
                <span className="font-semibold">
                  Maqsad: {userData.targetWeight} kg
                </span>
              </div>
          ...
          <CardContent className="pt-6">
            <Link to="/analytics" className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-xl text-water-800">
                    Tahlilni Ko'rish
                  </h3>
                  <p className="text-sm text-water-600 font-medium">
                    Haftalik taraqqiyotingizni kuzating
                  </p>
                </div>
              </div>
