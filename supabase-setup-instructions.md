...
## Database Schema O'rnatish

### **1. Supabase Dashboard'ga Kirish**

1. [supabase.com](https://supabase.com) ga boring
2. Login qiling
3. `naylpbrfthgqwvlzchnr` project'ini tanlang

### **2. SQL Editor'ga Kirish**

1. Left sidebar'dan "SQL Editor" ni bosing
2. "New query" tugmasini bosing

### **3. Database Schema'ni O'rnatish**

Quyidagi SQL kodini copy qilib, SQL Editor'ga paste qiling:
...
1. SQL kodini paste qilgandan so'ng
2. "Run" tugmasini bosing
3. Natijalarni kuzating

### **5. Authentication Sozlamalari**

1. Left sidebar'dan "Authentication" → "Settings" ga boring
2. "Enable email confirmations" ni o'chirib qo'ying
3. "Enable phone confirmations" ni o'chirib qo'ying

### **6. Test Qilish**

Schema o'rnatilgandan so'ng, test qilish uchun:
...
1. **RLS Policy Error**: Authentication sozlamalarini tekshiring
2. **Table Not Found**: SQL'ni qayta ijro eting
3. **Permission Error**: RLS policies'ni tekshiring

---

## ✅ SUCCESS CHECKLIST

- [ ] SQL Editor'ga kirildi
- [ ] Database schema o'rnatildi
- [ ] Indexes yaratildi
- [ ] RLS policies faol
- [ ] Authentication sozlandi
- [ ] Test o'tdi
...
Schema o'rnatilgandan so'ng:

1. **Test qiling**: `npm run test:db`
2. **Application'ni ishga tushiring**: `npm run dev`
